...
function enforceTwoDigitTwoDecimal(input) {
  ...
  if (parts.length > 3) {
    input =
      parts[0] + parts[1] + "." + parts.slice(1).join("").replace(/\./g, "");
  }
...
$(document).ready(function () {
  ...
  $("#txtAge").tooltip({
    title: "Please enter an age of 18 or greater",
    placement: "bottom",
    trigger: "manual",
  });
  $("#sexMark").tooltip({
  ...
  $("#raceMark").tooltip({
    title: "Please choose White, African American or Other",
    placement: "bottom",
    trigger: "manual",
  });
  $("#ethnMark").tooltip({
    title: "Please choose not Hispanic/Latino or Hispanic/Latino",
    placement: "bottom",
    trigger: "manual",
  });
  $("#txtHosp").tooltip({
    title: "Please enter a value between 1 and 365",
    placement: "bottom",
    trigger: "manual",
  });
  $("#diabMark").tooltip({
  ...
  $("#TotChol").tooltip({
    title:
      "Please enter total cholesterol between 0 and 500 mg/dL, leave blank if you do not have a value",
    placement: "bottom",
    trigger: "manual",
  });
  $("#BMI").tooltip({
  ...
  function dementia_Val() {
    return (
      $("input[name='Dementia']:checked").val() === "Yes" ||
  ...
  function afib_Val() {
    return (
      $("input[name='afib']:checked").val() === "Yes" ||
      $("input[name='afib']:checked").val() === "No"
    );
  }
  ...
  $("#sub").on("click", function (event) {
    ...
    if (
      ...
      risk_res = calc_risk();
      $("#message").html(
        "0-30 day &nbsp;&nbsp; survival probability = " +
          risk_res[0] +
          "%<br/>0-90 day &nbsp;&nbsp; survival probability = " +
          risk_res[1] +
          "%<br/>&nbsp;0-6 month survival probability =  " +
          risk_res[2] +
          "%</br>&nbsp;0-1 year &nbsp;&nbsp;&nbsp; survival probability = " +
          risk_res[3] +
          "%"
      );
      ...
      if (txtAge_Val()) {
        ...
        if (
          ...
          if (
            ...
            $("input[name = 'Race']:checked").val() != "Black" &&
              ...
              if (txtHosp_Val()) {
                if (
                  ...
                  if (
                    ...
                    if (
                      $("input[name = 'Hypertension']:checked").val() !==
                        "Yes" &&
                      $("input[name = 'Hypertension']:checked").val() !== "No"
                    ) {
                      ...
                      if (
                        ...
                        if (
                          ...
                          if (
                            $("input[name= 'priorKid']:checked").val() !==
                              "Yes" &&
                            $("input[name= 'priorKid']:checked").val() !== "No"
                          ) {
                            ...
                            if (
                              $("input[name= 'priorHF']:checked").val() !==
                                "Yes" &&
                              $("input[name= 'priorHF']:checked").val() !== "No"
                            ) {
...
function txtHosp_Val() {
  ...
  if (
    ...
    $("#myForm input").prop("disabled", false);
    $("#myForm button").prop("disabled", false);
    if (!txtHospFirst) $("#diab").focus();
    else txtHospFirst = false;
    return true;
  }
}
